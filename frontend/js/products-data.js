...
const PRODUCTS = [
  ...
  },
  {
    ...
    fullDescription: "Immerse in timeless grace with SG Fashion' Signature Banarasi Chanderi Saree. Features woven antique gold floral jaal work across the drape and a lavish heavy zari pallu. Comes with an unstitched contrast silk blouse piece.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "Stay effortlessly stylish in hot weather with SG Fashion' Handloom Cotton Linen Shirt. Pre-washed for superior softness, it features natural wooden accent buttons, a clean spread collar, and a patch chest pocket.",
    features: [
